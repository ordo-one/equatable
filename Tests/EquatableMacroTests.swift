...
struct EquatableMacroTests {
    @Test func testIdIsComparedFirst() async throws {
        assertMacro {
        """
        @Equatable
        struct Person {
    ...
    @Test func testBasicTypesComparedBeforeComplex() async throws {
        assertMacro {
        """
    ...
    @Test func testSwiftUIWrappedPropertiesSkipped() async throws {
        assertMacro {
        """
        @Equatable
    ...
    @Test func testMarkedWithEquatableIgnoredSkipped() async throws {
        assertMacro {
        """
        @Equatable
    ...
    @Test func testEquatableIgnoredCannotBeAppliedToClosures() async throws {
        assertMacro {
            """
    ...
    @Test func testNoEquatableProperties() async throws {
        assertMacro {
        """
        @Equatable
    ...
    @Test func testEquatableMacro() async throws {
        assertMacro {
        """
